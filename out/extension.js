...
function activate(context) {
    ...
    }
    {
        ...
        context.subscriptions.push(vscode.workspace.onDidChangeTextDocument(async (event) => {
             ...
             */
            for (const [str_trigger, str_match, str_add_before, str_add_after, str_go_back_length,] of str_autocomplete) {
                ...
                if (textBeforeTrigger.endsWith(str_trigger)) {
                    ...
                    if (match) {
                        ...
                        await editor.edit((editBuilder) => {
                            editBuilder.replace(new vscode.Range(replaceStartPosition, adjustedChangeEndPosition), str_add_before + matchedText + str_add_after);
                        });
                        /*
